...
main = tkinter.Tk()
main.title("Understanding the link between earthquakes and volcanic eruptions using  machine learning techniques") #designing main screen
...
font = ('times', 16, 'bold')
title = Label(main, text='Understanding the link between earthquakes and volcanic eruptions using  machine learning techniques')
